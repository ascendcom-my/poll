...
window.addEventListener('load', function () {
  ...
  var sortable = sortablejs__WEBPACK_IMPORTED_MODULE_0__.default.create(document.getElementById('sort-root'), {
    handle: '.sort-handle',
    dataIdAttr: 'data-token'
  });
  document.getElementById('sort-save').addEventListener('click', function (evt) {
    axios__WEBPACK_IMPORTED_MODULE_1___default().post(evt.currentTarget.dataset.route, {
      ...
      micromodal__WEBPACK_IMPORTED_MODULE_2__.default.show('modal-success');
    })["catch"](function (error) {
      document.getElementById('modal-error-message').innerHTML = error.response.data.message;
      micromodal__WEBPACK_IMPORTED_MODULE_2__.default.show('modal-error');
    });
  });
});
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/group.js");
