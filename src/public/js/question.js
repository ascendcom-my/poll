...
__webpack_require__(/*! ./micromodal.js */ "./resources/js/micromodal.js");

window.addEventListener('load', function () {
  (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__.default)('.flatpickr', {
    enableTime: true,
    dateFormat: 'Y-m-d H:i'
  });
  document.querySelectorAll('.btn-update').forEach(function (el) {
  ...
  document.querySelectorAll('.btn-fill-in').forEach(function (el) {
    el.addEventListener('click', function (evt) {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/question.js");
